...
class ReviewedArea(DBbase, ImageMixin):
	...
	def __post_init__(self):
		self.dimensions = Box((self.area_tx, self.area_ty), (self.area_bx, self.area_by))
...
class CreateReviewedAreaReq(BaseModel):
	image_id: UUID 
	name: str 
	ra_key: str
	area_tx: int
...
class ImportReviewedAreaReq(BaseModel):
	reviewed_areas: List[CreateReviewedAreaReq]
